...
# AGENTS.md — nectar-design

> **Canonical AI-builder configuration for the nectar-design package.** Follows the Sourcegraph [`AGENTS.md`](https://agents.md) universal convention. `CLAUDE.md` is now a 15-line pointer to this file for tools that hardcode the legacy path. Edits to AI-builder rules belong here.
